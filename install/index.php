...
<head>
	...
	<title>Easy Installer by MPA DAW</title>
...
<body>
						...
						<div class="box-item">
							...
							if ($action == 'result') {
								...
								if (isset($response['error']) && $response['error'] == 'ok') {
									...
									echo '<div class="warning mt-2"><h5 class="mb-4 fw-normal">Try again. Or you can ask for support by creating a support ticket.</h5><a href="?action=information" class="theme-button choto me-1 mb-3">Try Again</a> <a href="#" target="_blank" class="theme-button choto ms-1">create  ticket</a></div>';
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="#">MPA DAW</a></p>
		</div>
	</footer>
